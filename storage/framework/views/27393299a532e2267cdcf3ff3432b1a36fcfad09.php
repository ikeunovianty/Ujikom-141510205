...
<div class="col-md-3 ">
   <div class="panel panel-default">
       <div class="panel-heading">
        ...
        <div class="panel-heading"><h1><center><strong>Data Golongan</h1></strong></div>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <tr> 
                        ...
                        <?php echo $__env->make('modals.delete', ['url' => route('golongan.destroy', $data->id),'model' => $data], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </td>
                    </tr>
                </tbody>
