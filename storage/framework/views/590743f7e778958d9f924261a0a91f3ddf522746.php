<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-9">
        ...
        <div class="panel-heading" class="fa fa-paw" aria-hidden="true"><h1><center><strong>Data Tunjangan</h1></strong></div>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <tr> 
                        ...
                        <?php echo $__env->make('modals.delete', ['url' => route('tunjangan.destroy', $data->id),'model' => $data], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </td>
                    </tr>
                </tbody>
