			...
			<form method="POST" action="<?php echo e(url('jabatan')); ?>">
				...
				<div class="form-group">
                            ...
                            <div class="form-group <?php echo e($errors->has('kode_jabatan') ? 'has-errors':'message'); ?>" >
                                <input id="kode_jabatan" type="text" class="form-control" name="kode_jabatan" value="<?php echo e(old('kode_jabatan')); ?>" placeholder="Masukkan Kode Jabatan" autofocus>
                            ...
                            <div class="form-group <?php echo e($errors->has('nama_jabatan') ? 'has-errors':'message'); ?>" >
                                <input id="nama_jabatan" type="text" class="form-control" name="nama_jabatan" value="<?php echo e(old('nama_jabatan')); ?>" placeholder="Masukkan Nama Jabatan" autofocus>
